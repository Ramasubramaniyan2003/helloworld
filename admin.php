...
<body >
    ...
    <main>
        <div class="col-lg-12">
            <h1 class="fw-bolder text-center" id="project-title">ADMIN</h1>
        </div>
                                ...
                                <li class="list-group-item list-group-item-action item" data-id="<?= $row['id'] ?>">
                                    <div class="d-flex w-100 align-items-center">
                                        ...
                                        <div class="col-auto px-2">
                                             ...
                                             <button class="btn btn-outline-danger btn-sm rounded-circle delete" data-id="<?= $row['id'] ?>" onclick="fun()"><i class="fa fa-trash"></i></button> 
                                        </div>
                                    </div>
                                </li>
                                <?php endwhile; ?>
